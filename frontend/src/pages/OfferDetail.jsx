    ...
    return (
      <div className="pt-24 min-h-screen flex items-center justify-center">
        <div className="text-center">
          ...
          <Link to="/posts" className="text-orange-600 font-semibold">← Back to Posts</Link>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="pt-24 min-h-screen bg-gradient-to-br from-orange-600 via-white to-orange-500">
      <div className="max-w-4xl mx-auto px-6 py-12">
        <Link to="/posts" className="inline-flex items-center gap-2 text-orange-600 font-semibold mb-6">
              ...
              <div>
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <span className={`px-3 py-1 rounded-full text-xs font-semibold border ${
                    offer.status === 'active' ? 'bg-orange-500 text-orange-600 border-orange-400' :
          ...
          <div className="bg-white rounded-3xl shadow-xl p-8 mb-8">
            <div className="flex justify-between items-center mb-6">
              ...
              {canLink && (
                <button onClick={() => setShowLinkModal(true)}
                  className="px-4 py-2 bg-gradient-to-r from-orange-600 to-orange-500 text-white rounded-xl font-semibold text-sm shadow-md hover:shadow-lg transition-all">
                  Manage Links
                </button>
              )}
            </div>
            ...
            {linkedCourses.length === 0 ? (
              <div className="text-center py-8">
                ...
                {canLink && (
                  <button onClick={() => setShowLinkModal(true)}
                    className="mt-4 text-orange-600 font-semibold text-sm hover:text-orange-600">
                    Link a course →
                  </button>
                )}
              </div>
              ...
              <div className="space-y-3">
                {linkedCourses.map(course => (
                  <Link
                    ...
                    className="block p-4 bg-gray-50 rounded-xl hover:bg-orange-500 transition-colors group"
                  >
                      ...
                      <div>
                        ...
                        <div className="flex items-center gap-2 mt-1">
                          <span className={`px-2 py-0.5 rounded-full text-xs font-medium ${
                            course.status === 'active' ? 'bg-orange-500 text-orange-600' : 'bg-gray-100 text-gray-600'
                          }`}>
                            {course.status}
                          </span>
                  ...
                  >
                    <div className="flex items-start justify-between">
                      <div>
                        ...
                        <div className="flex items-center gap-2 mt-1">
                          <span className={`px-2 py-0.5 rounded-full text-xs font-medium ${
                            ls.effective_status === 'active' ? 'bg-orange-500 text-orange-600' : 'bg-gray-100 text-gray-600'
                          }`}>
                            {ls.effective_status}
                          </span>
