        ...
        >
          ...
          <div className="flex flex-wrap items-center gap-4">
            ...
            <select
              ...
              className="px-4 py-3 rounded-xl border border-gray-300 text-sm font-medium focus:ring-2 focus:ring-orange-400 outline-none"
            >
              {CATEGORIES.map(cat => (
                ...
                {loading ? (
                  ...
                  resources.map(resource => (
                    ...
                    >
                      ...
                      <td className="px-6 py-4">
                        <span className="px-2 py-1 bg-orange-500 text-orange-600 rounded-full text-xs font-semibold">
                          {resource.category}
                        </span>
                      </td>
