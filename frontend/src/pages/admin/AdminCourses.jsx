        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="mb-8">
          ...
          <div className="flex flex-wrap gap-3">
            <select
              ...
              className="px-4 py-2 rounded-xl border border-gray-300 text-sm focus:ring-2 focus:ring-orange-400 outline-none"
            >
              {CATEGORIES.map(cat => (
                  ...
                  courses.map(course => (
                    ...
                    >
                      <td className="px-6 py-4">
                        <Link to={`/courses/${course.id}`} className="font-medium text-gray-900 hover:text-orange-600">
                          {course.title}
                        </Link>
                      ...
                      <td className="px-6 py-4">
                        <select
                          ...
                          className={`px-2 py-1 rounded-lg text-xs font-semibold border outline-none cursor-pointer ${
                            course.status === 'active' ? 'bg-orange-500 text-orange-600 border-orange-400' :
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              ...
              <textarea name="description" value={formData.description} onChange={handleChange} rows={3}
                className="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-orange-400 focus:border-orange-400 transition-all outline-none resize-none" />
            </div>
            ...
            <div className="flex gap-3 pt-4">
              ...
              <motion.button type="submit" disabled={loading}
                ...
                className="flex-1 py-3 bg-gradient-to-r from-orange-600 to-orange-500 text-white font-semibold rounded-xl shadow-lg disabled:opacity-50">
