...
export default function GoogleCallback() {
  ...
  if (processing && !error) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-[#F2DDD8]">
        <div className="text-center">
          <motion.div
            animate={{ rotate: 360 }}
            transition={{ duration: 2, repeat: Infinity, ease: "linear" }}
            className="w-16 h-16 mx-auto mb-6 bg-gradient-to-br from-[#C26100] to-[#E07A1B] rounded-full flex items-center justify-center"
          >
        ...
        >
          ...
          <div className="flex flex-col gap-3">
            <button
              ...
              className="w-full py-3 bg-gradient-to-r from-[#C26100] to-[#E07A1B] text-white font-semibold rounded-xl shadow-lg"
            >
              Try Again
            </button>
            <button
