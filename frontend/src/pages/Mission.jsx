    ...
    <div className="pt-24">
      <section className="relative py-20 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-6">
          ...
          >
            <span className="inline-block px-4 py-2 bg-orange-500 text-orange-600 rounded-full text-sm font-semibold mb-4 border border-orange-400">
              Our Purpose
            </span>
            <h1 className="text-5xl md:text-7xl font-bold mb-6">
              Our <span className="bg-gradient-to-r from-orange-600 to-orange-500 bg-clip-text text-transparent">Mission</span>
            </h1>
          ...
          >
            ...
            <Link to="/#">
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                className="px-8 py-4 bg-gradient-to-r from-orange-600 to-orange-500 text-white font-semibold rounded-full shadow-lg"
              >
                Get Involved
              </motion.button>
            </Link>
