        ...
        <div className="relative max-w-7xl mx-auto px-6">
          ...
          >
            ...
            <h1 className="text-5xl md:text-7xl font-bold mb-6">
              Our <span className="bg-gradient-to-r from-[#1a2e1a] to-[#e18f23] bg-clip-text text-transparent">Mission</span>
            </h1>
          ...
          >
            ...
            <Link to="/#">
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                className="px-8 py-4 bg-[#e18f23] hover:bg-[#c97a18] text-white font-semibold rounded-full shadow-lg"
              >
                Get Involved
              </motion.button>
            </Link>
