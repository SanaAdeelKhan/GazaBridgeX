                ...
                {STEPS.map((stepName, index) => (
                  <div key={stepName} className="flex items-center">
                    <div className={`flex items-center justify-center w-8 h-8 rounded-full text-sm font-semibold ${
                      index + 1 <= step
                        ? 'bg-[#e18f23] hover:bg-[#c97a18] text-white'
                        : 'bg-gray-200 text-gray-500'
                    }`}>
                      {index + 1 < step ? '✓' : index + 1}
                    </div>
                    <span className={`ml-2 text-sm font-medium hidden sm:block ${
                      index + 1 <= step ? 'text-[#C97B1A]' : 'text-gray-400'
                    }`}>
                      {stepName}
                    </span>
                    {index < STEPS.length - 1 && (
                      <div className={`w-12 sm:w-20 h-0.5 mx-2 ${
                        index + 1 < step ? 'bg-[#fdf3e3]0' : 'bg-gray-200'
                      }`} />
                    )}
                  </div>
                ))}
              ...
              <div className="flex gap-4 mt-8">
                ...
                {step < 2 ? (
                  <motion.button
                    ...
                    whileHover={{ scale: 1.02 }}
                    whileTap={{ scale: 0.98 }}
                    className="flex-1 py-3 bg-[#e18f23] hover:bg-[#c97a18] text-white font-semibold rounded-xl shadow-lg shadow-emerald-500/25 hover:shadow-emerald-500/40 transition-all"
                  >
                    Continue
                  </motion.button>
                ) : (
                  <motion.button
                    ...
                    className="flex-1 py-3 bg-[#e18f23] hover:bg-[#c97a18] text-white font-semibold rounded-xl shadow-lg shadow-emerald-500/25 hover:shadow-emerald-500/40 transition-all disabled:opacity-50 disabled:cursor-not-allowed"
                  >
                    {loading ? (
