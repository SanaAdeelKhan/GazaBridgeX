      ...
      <motion.div
        ...
        className={`relative p-6 rounded-2xl border cursor-pointer transition-all duration-300 group ${
          notification.is_read
            ...
            : 'bg-orange-500 border-orange-400 hover:border-orange-400 shadow-md'
        }`}
      >
          ...
          <div className="flex items-center justify-between mb-6">
            ...
            <div className="flex gap-2">
              <motion.button
                ...
                className="px-4 py-2 text-sm font-medium text-orange-600 bg-orange-500 hover:bg-orange-500 rounded-xl transition-colors disabled:opacity-50"
              >
                Mark All Read
              </motion.button>
              <motion.button
