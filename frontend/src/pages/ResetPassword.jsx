      ...
      >
          ...
          {success && (
            ...
            >
              <motion.div
                ...
                className="w-20 h-20 mx-auto mb-6 bg-gradient-to-br from-orange-600 to-orange-500 rounded-full flex items-center justify-center"
              >
              ...
              <Link
                to="/login"
                className="inline-flex items-center gap-2 px-8 py-3 bg-gradient-to-r from-orange-600 to-orange-500 text-white font-semibold rounded-xl shadow-lg hover:shadow-xl transition-all"
              >
                Go to Login Now
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                <div>
                  ...
                  <input
                    ...
                    autoFocus
                    className="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-orange-400 focus:border-orange-400 transition-all outline-none text-gray-900 placeholder-gray-400"
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    className={`w-full px-4 py-3 border rounded-xl focus:ring-2 focus:ring-orange-400 focus:border-orange-400 transition-all outline-none text-gray-900 placeholder-gray-400 ${
                  ...
                  {passwords.confirm_password && passwords.new_password === passwords.confirm_password && (
                    <p className="mt-2 text-sm text-orange-600">✓ Passwords match</p>
                  )}
                </div>
                  ...
                  <ul className="space-y-2">
                    {[
                      ...
                      <li key={index} className="flex items-center gap-2 text-sm">
                        ...
                        <span className={passwords.new_password ? (req.met ? 'text-orange-600' : 'text-gray-500') : 'text-gray-500'}>
                          {req.label}
                        </span>
                      </li>
                    ))}
        ...
        {!success && (
          <p className="text-center mt-6 text-gray-600">
            ...
            <Link to="/login" className="text-orange-600 hover:text-orange-600 font-semibold">
              Sign in
            </Link>
          </p>
        )}
