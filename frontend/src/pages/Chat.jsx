        ...
        <div className="px-4 pt-5 pb-3 border-b border-gray-100">
          ...
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-9 pr-4 py-2 bg-gray-100 rounded-xl text-sm text-gray-700 outline-none focus:bg-white focus:ring-2 focus:ring-orange-400 transition-all"
            />
          </div>
        ...
        <div className="flex-1 overflow-y-auto">
          {loadingList ? (
            <div className="flex justify-center py-10">
              <div className="animate-spin w-6 h-6 border-4 border-orange-400 border-t-transparent rounded-full" />
            </div>
          ) : (
            <ConversationList
        ...
        <AnimatePresence mode="wait">
          {activeChat ? (
            ...
            <motion.div
              ...
              exit={{ opacity: 0 }}
            >
              <div className="w-24 h-24 bg-gradient-to-br from-orange-600 to-orange-500 rounded-full flex items-center justify-center text-5xl shadow-inner">
                💬
              </div>
              <div>
              ...
              <div className="flex gap-3">
                <button
                  id="empty-new-dm-btn"
                  onClick={() => setShowStartConv(true)}
                  className="px-5 py-2.5 bg-gradient-to-r from-orange-600 to-orange-500 text-white text-sm font-semibold rounded-xl shadow-md hover:shadow-lg transition-all"
                >
                  New Message
                </button>
                <button
