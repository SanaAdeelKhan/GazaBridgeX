    ...
    <section id="home" className="relative min-h-screen flex items-center overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <FloatingElement delay={4} duration={6} className="bottom-40 left-1/4">
          <div className="w-20 h-20 bg-[#C97B1A]/20 rounded-full blur-xl" />
        </FloatingElement>
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <motion.div
              ...
              className="inline-flex items-center px-4 py-2 bg-[#fdf3e3] rounded-full border border-emerald-200"
            >
              ...
              <span className="text-sm font-medium text-[#1a2e1a]">Empowering Gaza Through Digital Skills</span>
            </motion.div>
            ...
            >
              ...
              <span className="relative">
                <span className="bg-gradient-to-r from-[#1a2e1a] to-[#e18f23] bg-clip-text text-transparent">
                  Future
                </span>
                <motion.svg
            ...
            >
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                className="px-8 py-4 bg-[#e18f23] hover:bg-[#c97a18] text-white font-semibold rounded-full shadow-xl shadow-emerald-500/25 hover:shadow-2xl transition-all duration-300"
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                className="px-8 py-4 border-2 border-gray-300 text-gray-700 font-semibold rounded-full hover:border-emerald-300 hover:text-[#C97B1A] transition-all duration-300"
                onClick={() => window.location.href = '#'}
              >
                Become a Volunteer
              </motion.button>
              ...
              <div className="flex -space-x-3">
                {[...Array(4)].map((_, i) => (
                  <motion.div
                    ...
                    className="w-10 h-10 rounded-full border-2 border-white bg-gradient-to-br from-[#e18f23] to-[#E8920F] flex items-center justify-center text-white text-xs font-bold shadow-lg"
                  >
          ...
          >
            <div className="relative w-full h-[500px]">
              ...
              <motion.div
                ...
                className="absolute inset-0 bg-gradient-to-br from-[#e18f23]/20 to-[#E8920F]/20 rounded-3xl backdrop-blur-3xl border border-white/30 shadow-2xl"
              >
                <div className="absolute inset-4 bg-white/40 backdrop-blur-xl rounded-2xl p-8 flex items-center justify-center">
                  <div className="text-center">
                    <motion.div
                      ...
                      className="w-24 h-24 mx-auto mb-6 bg-gradient-to-br from-[#e18f23] to-[#e18f23] rounded-full flex items-center justify-center"
                    >
              ...
              >
                <div className="flex items-center space-x-3">
                  <div className="w-10 h-10 bg-[#fdf3e3] rounded-full flex items-center justify-center">
                    <svg className="w-6 h-6 text-[#C97B1A]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              >
                <div className="text-center">
                  <div className="text-2xl font-bold text-[#C97B1A]">100%</div>
