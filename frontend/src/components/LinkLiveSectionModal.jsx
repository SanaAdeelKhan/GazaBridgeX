        ...
        >
          <div className="p-6 border-b border-gray-100">
            <div className="flex items-center justify-between mb-4">
              <div>
                <h2 className="text-2xl font-bold" style={{ color: colors.headingDark }}>Link Live Sections to Offer</h2>
                      ...
                      <div className="flex items-start justify-between gap-4">
                        <div className="flex-1">
                          <div className="flex items-center gap-2">
                            <h3 className="font-semibold" style={{ color: colors.headingDark }}>{ls.title}</h3>
                            {!isOwner && isAdmin && (
                          ...
                          <div className="flex items-center gap-3 mt-1">
                            <span className="text-xs capitalize" style={{ color: colors.muted }}>{ls.skill_level}</span>
                            <span className="text-xs" style={{ color: colors.muted }}>•</span>
                            <span className="text-xs uppercase" style={{ color: colors.muted }}>{ls.language}</span>
                            <span className="text-xs" style={{ color: colors.muted }}>•</span>
                            <span className="text-xs" style={{ color: colors.muted }}>Ends: {new Date(ls.ending_date).toLocaleDateString()}</span>
                          </div>
                          <p className="text-sm mt-2 line-clamp-2" style={{ color: colors.body }}>{ls.description}</p>
                        </div>
