                    ...
                    >
                        ...
                        <div className="flex-1">
                          <div className="flex items-center gap-2">
                            ...
                            <span className={`px-2 py-0.5 rounded-full text-xs font-medium ${
                              effectiveStatus === 'active' ? 'bg-orange-500 text-orange-600' : 'bg-gray-100 text-gray-600'
                            }`}>
                              {effectiveStatus}
                            </span>
                          </div>
                          ...
                          <motion.button
                            ...
                            className={`px-4 py-2 rounded-xl text-sm font-semibold transition-all flex-shrink-0 ${
                              isLinked
                                ...
                                : 'bg-gradient-to-r from-orange-600 to-orange-500 text-white shadow-md hover:shadow-lg'
                            } disabled:opacity-50`}
                          >
                      ...
                      {isLinked && (
                        <div className="flex items-center gap-2 mt-3 pt-3 border-t border-orange-400">
                          ...
                          <span className="text-xs text-orange-600 font-medium">Linked to this offer</span>
                        </div>
                      )}
                    </div>
                  );
