          ...
          <div>
            ...
            <div className="flex items-center gap-1.5">
              <span className={`inline-block w-2 h-2 rounded-full ${
                wsStatus === 'open' ? 'bg-orange-500' : wsStatus === 'connecting' ? 'bg-amber-400 animate-pulse' : 'bg-red-400'
              }`} />
        ...
        {loading ? (
          ...
          <div className="flex flex-col items-center justify-center h-full text-gray-400 gap-3">
            <div className={`w-16 h-16 rounded-full flex items-center justify-center text-3xl ${
              chat?.type === 'dm' ? 'bg-orange-500' : 'bg-purple-50'
            }`}>
              {chat?.type === 'dm' ? '💬' : '👥'}
            </div>
                ...
                >
                  <div className={`max-w-[72%] ${isMe ? 'items-end' : 'items-start'} flex flex-col`}>
                    ...
                    <div className={`px-4 py-2.5 rounded-2xl text-sm whitespace-pre-wrap break-words leading-relaxed shadow-sm ${
                      isMe
                        ? 'bg-gradient-to-br from-orange-600 to-orange-500 text-white rounded-br-sm'
      ...
      >
        <div className="flex gap-2 items-end">
          <input
            ...
            className="flex-1 px-4 py-3 border border-gray-200 rounded-2xl text-sm focus:ring-2 focus:ring-orange-400 focus:border-orange-400 transition-all outline-none bg-gray-50 placeholder:text-gray-400 disabled:opacity-60"
          />
          <motion.button
            id="chat-send-btn"
            type="submit"
            ...
            className="flex-shrink-0 w-11 h-11 flex items-center justify-center bg-gradient-to-br from-orange-600 to-orange-500 text-white rounded-2xl shadow-md hover:shadow-lg transition-all disabled:opacity-50 disabled:cursor-not-allowed"
          >
