        ...
        <div className="space-y-6">
            ...
            <div className="flex items-center gap-3">
                ...
                <div className="flex gap-2">
                    {['newest', 'rating'].map((option) => (
                        <button
                            key={option}
                            onClick={() => setSort(option)}
                            className={`px-3 py-1.5 rounded-full text-xs font-medium transition-all ${sort === option ? 'text-white' : ''
                                }`}
                            style={sort === option ? { backgroundColor: colors.gold } : {
                                backgroundColor: colors.pageBg,
                                color: colors.muted,
                            }}
                        >
                            {option === 'newest' ? 'Newest' : 'Highest Rated'}
                        </button>
                    ))}
                </div>
            </div>
